// @generated by AIDL; ownership=aidl; sha256=9f3cdbaa6b2b47145c5ad193889b96f00887660c1c9f5d5ae211f28cefe47784
...
export const outboxPublishPlans: ReadonlyArray<OutboxPublishPlan> = [{"eventFqn":"fixtures.valid.m4minimal.SnapshotItemCreated","eventId":"fixtures.valid.m4minimal.SnapshotItemCreated@1","eventVersion":1,"kind":"publish","operationFqn":"fixtures.valid.m4minimal.createItem","operationId":"fixtures.valid.m4minimal.createItem@1","partitionField":"itemId","payload":{"fields":[{"name":"eventId","value":{"arguments":[],"function":"operationId","kind":"call"}},{"name":"itemId","value":{"kind":"symbol","path":["item","id"]}},{"name":"occurredAt","value":{"arguments":[],"function":"now","kind":"call"}}],"kind":"record"},"retentionMs":2592000000,"sql":"INSERT INTO \"aidl_outbox\" (\"event_id\", \"event_type\", \"event_version\", \"topic\", \"partition_key\", \"payload\", \"occurred_at\", \"expires_at\") VALUES ($1, $2, $3, $4, $5, $6::jsonb, $7::timestamptz, CURRENT_TIMESTAMP + ($8 * INTERVAL '1 millisecond'))","stepIndex":1,"topicFqn":"fixtures.valid.m4minimal.SnapshotItemEvents","topicId":"fixtures.valid.m4minimal.SnapshotItemEvents@1"}] as ReadonlyArray<OutboxPublishPlan>;
