// @generated by AIDL; ownership=aidl; sha256=c38afb0b124946a0bf69fb4aa7f75aba3d8bf7f59df38d97c29081bacd0af1f3
...
export const transactionPlans: ReadonlyArray<TransactionPlan> = [{"isolation":"readCommitted","isolationSql":"READ COMMITTED","operationFqn":"fixtures.valid.m4minimal.createItem","operationId":"fixtures.valid.m4minimal.createItem@1","operationName":"createItem","resourceId":"fixtures.valid.m4minimal.SnapshotDb@1","result":{"kind":"symbol","path":["item"]},"steps":[{"bind":"item","kind":"create","sql":"INSERT INTO \"fixtures_valid_m4minimal_snapshotitem\" (\"id\", \"name\") VALUES ($1, $2) RETURNING *","values":[{"kind":"symbol","path":["input","id"]},{"kind":"symbol","path":["input","name"]}]},{"eventFqn":"fixtures.valid.m4minimal.SnapshotItemCreated","eventId":"fixtures.valid.m4minimal.SnapshotItemCreated@1","eventVersion":1,"kind":"publish","partitionField":"itemId","payload":{"fields":[{"name":"eventId","value":{"arguments":[],"function":"operationId","kind":"call"}},{"name":"itemId","value":{"kind":"symbol","path":["item","id"]}},{"name":"occurredAt","value":{"arguments":[],"function":"now","kind":"call"}}],"kind":"record"},"retentionMs":2592000000,"sql":"INSERT INTO \"aidl_outbox\" (\"event_id\", \"event_type\", \"event_version\", \"topic\", \"partition_key\", \"payload\", \"occurred_at\", \"expires_at\") VALUES ($1, $2, $3, $4, $5, $6::jsonb, $7::timestamptz, CURRENT_TIMESTAMP + ($8 * INTERVAL '1 millisecond'))","topicFqn":"fixtures.valid.m4minimal.SnapshotItemEvents","topicId":"fixtures.valid.m4minimal.SnapshotItemEvents@1"}]}] as ReadonlyArray<TransactionPlan>;
...
export async function executeCreateItemTransaction(client: PgTransactionClient, input: unknown): Promise<unknown> {
