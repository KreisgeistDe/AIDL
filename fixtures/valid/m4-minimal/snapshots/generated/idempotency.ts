// @generated by AIDL; ownership=aidl; sha256=f60dd7e26a8a8890b77a8df08b8550cdae489b0605f7cf7ab3679493c87aa9e3
...
export const idempotencyPlans: ReadonlyArray<IdempotencyPlan> = [{"key":{"kind":"literal","value":"snapshot-create"},"operationFqn":"fixtures.valid.m4minimal.createItem","operationId":"fixtures.valid.m4minimal.createItem@1","operationName":"createItem","resourceId":"fixtures.valid.m4minimal.SnapshotDb@1","retentionMs":86400000,"scope":{"kind":"literal","value":"mutation"}}] as ReadonlyArray<IdempotencyPlan>;
...
export async function executeCreateItemIdempotent(client: PgIdempotencyClient, input: unknown, execute: () => Promise<unknown>): Promise<unknown> {
