...
- [ ] **M10.5-02 and later Kotlin work.** Dependency-ready next roadmap action after the completed Gate-01 reconciliation. PR #88's integrated TypeConstruction slice remains bounded historical evidence; this status correction does not itself implement semantics-dependent Kotlin work.
