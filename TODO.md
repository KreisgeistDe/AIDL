...
- [x] **M10.5-01 — Refresh the Python parity baseline and differential harness.** Independently validated at exact PR #94 head `9228f94302c1fbbc6cd5fc0b5fc7af9231071d76` and integrated on main as `fcfc3fc92e6577270dbf89be22c4ddfac5c187a9`. The accepted post-G1 baseline was derived from exact `main@f471fd9c1ee808ff9557d4a9f6bdf8b092d9c2c5`, preserves Core/Core-authored modules as the sole permanent semantic authority, separately fingerprint-binds the three Core authority inputs, preserves the inherited six parity bindings and exact `source`/`config`/`profile` runner identity, and keeps revision 4 compatibility/conformance-only. PR #77 remains already-merged historical/provisional evidence on main via `1574963eed95a2f80c1cdc47f48a3eaa39df4a4b`; it is not a future integration target.
- [ ] **M10.5-02 and later Kotlin work.** Next roadmap action, but blocked until this durable-state correction for the already-integrated Gate 01 receives fresh independent exact-head validation and later integration. PR #88's integrated TypeConstruction slice remains bounded historical evidence; no semantics-dependent Kotlin work is part of this correction.
