...
[M10.5 — Kotlin Compiler-Core Migration Gate](backlog/m10-5-kotlin-compiler-migration.md) has completed its first two internal gates and is no longer blocked by the binding Core EBNF correction. Python and revision-4 artifacts remain compatibility/conformance evidence under direct Core-owned authority. Gate 03 has accumulated integrated front-end parity slices but still requires its own independent closure audit before M10.5-04+ becomes eligible.
...
- [ ] **M10.5-03 — Front-end semantic parity closure.** The binding Core EBNF correction prerequisite is complete. Gate 03 remains open only for its own independent closure audit over the integrated parsing/source-projection, resolution, TypeConstruction/type-checking, serialization, materialization, location, recursion and diagnostic-parity evidence. This status recovery does not close Gate 03 or authorize M10.5-04+.
