...
4. [M10.5 — Kotlin Compiler-Core Migration Gate](backlog/m10-5-kotlin-compiler-migration.md)
5. [M11 — Production language server and compiler service](backlog/m11-compiler-service.md)
6. [M12–M14 — Runtime vertical slices](backlog/m12-m14-runtime-vertical-slices.md)
7. [M15–M16 — Ecosystem readiness and agent construction](backlog/m15-m16-ecosystem-agents.md)
8. [M16.5 — Language Surface Normalization Gate](backlog/m16-5-language-surface-normalization.md)
9. [M17–M21 — Full specified-language coverage](backlog/m17-m21-full-language-coverage.md)
10. [Specification-to-roadmap gap matrix](backlog/spec-roadmap-gap-matrix.md)
11. [Roadmap policy, Definition of Done, and recommended execution order](backlog/policy-and-execution.md)
