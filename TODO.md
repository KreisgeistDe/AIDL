...
- [ ] **M10.5-03 and later Kotlin semantic work.** The binding Core EBNF correction prerequisite is complete. Gate 03 remains incomplete and open only for its own independent closure audit over the integrated parsing/source-projection, resolution, TypeConstruction/type-checking, serialization, materialization, location, recursion and diagnostic-parity evidence. This status recovery does not close Gate 03 or authorize M10.5-04+.
