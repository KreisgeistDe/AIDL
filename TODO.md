...
- [ ] **M10.5-01 — Refresh the Python parity baseline and differential harness.** **Current post-G1 candidate.** PR #77 remains already-merged historical/provisional evidence on main via `1574963eed95a2f80c1cdc47f48a3eaa39df4a4b`; it is not a future integration target. The new post-G1 current-main Gate-01 refresh candidate is derived from exact `main@f471fd9c1ee808ff9557d4a9f6bdf8b092d9c2c5`, binds Core-owned authority plus the current Python/IR/profile/M10.2/M10.3 evidence, and requires fresh independent validation and integration before Gate 01 can be durably complete.
