...
- [ ] **M10.5-03 and later Kotlin semantic work.** Gate 03 remains incomplete and frozen pending independent validation/integration of the binding Core EBNF correction. Existing `SourceProjection`, `NameResolution`, and `TypeConstruction` code is bounded historical evidence only and does not establish Gate-03 completion or move semantic authority away from Python/direct Core.
