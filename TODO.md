...
## M11-1 blocking language-freeze gate

[M11-1 — Normative Language Surface Freeze Gate](backlog/m11-1-language-freeze.md) is the language-design authority that must be reviewed before M10.5-03 front-end/IR migration and before further M16.5 syntax adoption. M10.5-01/-02 work that is genuinely migration-neutral may continue independently. Existing legacy syntax remains accepted until an explicit versioned parser/migrator implementation; there is no permanent parallel grammar.
...
5. [M11-1 — Normative Language Surface Freeze Gate](backlog/m11-1-language-freeze.md)
