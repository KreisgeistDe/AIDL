...
- Validate: `tools/test_m5_fixture_corpus.py`, `tools/test_core_enum_ir_semantics.py`, `tools/test_core_event_ir_semantics.py`, `tools/test_core_topic_materialization_contract.py`, and `tools/test_core_typecheck.py`
